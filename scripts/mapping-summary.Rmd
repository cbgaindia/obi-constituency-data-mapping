...
# scheme_mapping_summary <- readr::read_csv("../data/results/mnrega-2019-20-geography-mapping-summary.csv")
scheme_mapping_summary <- readr::read_csv("../data/results/mnrega-2018-19-geography-mapping-summary.csv")
```
