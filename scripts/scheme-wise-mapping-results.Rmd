...
```{r district-summary-mnrega-2018-19}

district_wise_mapping_summary <- bind_rows(district_wise_mapping_summary)
mnrega_2018_district_wise_mapping_summary <- district_wise_mapping_summary[district_wise_mapping_summary$scheme_name=="mnrega-2018-19",]
mnrega_2018_district_wise_mapping_summary$scheme_name <- NULL


mnrega_2018_district_wise_mapping_summary_t <- mnrega_2018_district_wise_mapping_summary %>% arrange(desc(mapping_percent)) %>% gt(rowname_col = "g_district") %>%    tab_stubhead(label = "District") %>%  cols_label(
    g_district = "District",
    total_GP = "totalGP",
    mapped_GP = "mappedGP",
...
mnrega_2018_district_wise_mapping_summary_t
```
<br />
...
| MNREGA | 2019-20 | [Link](../data/results/mnrega-2019-20-geography-mapping-summary.csv)        | [Link](../data/scheme/MNREGA/odisha/2019-20/raw/csv/MGNREGA-Odisha-2019-20.csv)      | [Link](..//data/scheme/MNREGA/odisha/2019-20/updated/odisha-mnrega-2019-updated.csv)           |
